        ...
        <div className="container px-6 py-3 mx-auto md:flex">
          ...
          >
            ...
            <div className="relative mt-4 md:mt-0">
              ...
              <input
                type="text"
                className="w-full py-2 pl-10 pr-4 text-gray-800 bg-white border rounded-lg dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
                placeholder="Search"
              />
            </div>
          </div>
